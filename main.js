...
module.exports = "<h1 *ngIf=\"detail\">{{ detail.name }}</h1>\n\n<ul *ngIf=\"detail\">\n  <li><strong>Username: </strong>{{ detail.username }}</li>\n  <li><strong>Email: </strong>{{ detail.email }}</li>\n  <li><strong>Phone: </strong>{{ detail.phone }}</li>\n  <select [(ngModel)]=\"formOp\"\n  (change)=\"placeholder()\">\n    <option value=\"name\">Name</option>\n    <option value=\"email\">Email</option>\n    <option value=\"phone\">Phone</option>\n    <option value=\"username\">Username</option>\n  </select>\n  <input type=\"text\"\n  [(ngModel)]=\"input\"\n  (input)=\"update()\">\n</ul>"
...
var DetailsComponent = /** @class */ (function () {
    ...
    DetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getUser(this.userId).subscribe(function (x) {
            _this.detail = x;
            _this.input = _this.detail.name;
        });
    };
    ...
    DetailsComponent.prototype.placeholder = function () {
        switch (this.formOp) {
            case 'name':
...
var PostsComponent = /** @class */ (function () {
    ...
    PostsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getPosts().subscribe(function (x) { return _this.posts = x; });
    };
...
var UsersComponent = /** @class */ (function () {
    ...
    UsersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getUsers().subscribe(function (x) { return _this.users = x; });
    };
